...
public class NodeDataManagedBean implements Serializable, IObserver {
    ...
    public void refreshNodeProperties(String selectedNode) {
        ...
        nodeProps = nodeBusiness.findPropertyItems(nodeAuth.getAuthedNode(), versionMB.getSelectedVersion(),
            selectedNode);
    }
    ...
    public void createProperty() {
        ...
        if (created) {
            ...
            FacesContext.getCurrentInstance().addMessage(null,
                new FacesMessage(FacesMessage.SEVERITY_ERROR, "Property creation failed.", propPath));
        }
    }
