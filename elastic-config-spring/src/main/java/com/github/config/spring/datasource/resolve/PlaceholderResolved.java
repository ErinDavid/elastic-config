...
public final class PlaceholderResolved {
	...
	private MutablePropertySources mergePropertySources(PropertySourcesPlaceholderConfigurer placeholderConfigurer) {
		...
		return this.builder(placeholderConfigurer).environmentSources().localPropertiesSources().elastiConfigSources().bulid();
	}
	 ...
	 */
	private Map<String, PropertySourcesPlaceholderConfigurer> initPlaceholderMap(final ConfigurableListableBeanFactory beanFactory) {

		Map<String, PropertySourcesPlaceholderConfigurer> placeholderMap = beanFactory.getBeansOfType(PropertySourcesPlaceholderConfigurer.class, true, false);
		if (placeholderMap.isEmpty()) {
			beanFactory.registerSingleton(PropertySourcesPlaceholderConfigurer.class.getCanonicalName(), new PropertySourcesPlaceholderConfigurer());
	...
	private Optional<PropertiesPropertySource> getLocalPropertiesSources(PropertySourcesPlaceholderConfigurer placeholderConfigurer) {
	...
	@SneakyThrows
	private Optional<MutablePropertySources> getPropertySourcesSources(PropertySourcesPlaceholderConfigurer placeholderConfigurer) {
	...
	private PropertySourcesPropertyResolver getPropertyResolverBeforeSpring4(final PropertySourcesPlaceholderConfigurer placeholderConfigurer)
		...
		return new PropertySourcesPropertyResolver((PropertySources) PropertySourcesPlaceholderConfigurer.class.getField("propertySources").get(
