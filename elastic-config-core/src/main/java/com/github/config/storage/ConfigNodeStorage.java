...
public class ConfigNodeStorage {
    ...
    public boolean isRootConfigNodeExisted(final String node) {
        return elasticConfigRegistryCenter.isExisted(configProfile.getVersionRootNodePath(node));
    }
    ...
    public boolean isConfigNodeExisted(final String node) {
        return elasticConfigRegistryCenter.isExisted(configProfile.getFullPath(node));
    }
    ...
    public String getConfigNodeDataDirectly(final String node) {
        return elasticConfigRegistryCenter.getDirectly(configProfile.getFullPath(node));
    }
    ...
    public List<String> getConfigNodeChildrenKeys(final String node) {
        return elasticConfigRegistryCenter.getChildrenKeys(configProfile.getVersionRootNodePath(node));
    }
     ...
     * @param value 作业节点数据值
     */
    public void fillConfigNodeIfNullOrOverwrite(final String node, final Object value) {
        if (!isConfigNodeExisted(node) || !value.toString().equals(getConfigNodeDataDirectly(node))) {
            elasticConfigRegistryCenter.persist(configProfile.getFullPath(node), value.toString());
        }
    }
    ...
    public void fillEphemeralConfigNode(final String node, final Object value) {
        elasticConfigRegistryCenter.persistEphemeral(configProfile.getFullPath(node), value.toString());
    }
    ...
    public void updateConfigNode(final String node, final Object value) {
        elasticConfigRegistryCenter.update(configProfile.getFullPath(node), value.toString());
    }
